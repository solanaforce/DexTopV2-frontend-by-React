...
import { AutoColumn, ChartDisableIcon, LineGraphIcon, LiquidityIcon, LogoIcon, TradeIcon } from 'components'
import { BunnyKnownPlaceholder } from 'components/BunnyKnownPlaceholder'
...
export default function LiquidityChartRangeInput({
  ...
  return (
    <AutoColumn gap="md" style={{ minHeight: '200px', width: '100%', marginBottom: '16px' }}>
      {isUninitialized ? (
        <InfoBox message='Your position will appear here.' icon={<TradeIcon width="40px" />} />
      ) : isLoading ? (
