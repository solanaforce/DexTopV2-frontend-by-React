...
import { Currency, CurrencyAmount, Percent, BigintIsh } from 'libraries/swap-sdk'
import { deserializeToken } from 'libraries/token-lists'
import { FeeAmount, DEPLOYER_ADDRESSES, parseProtocolFees } from 'libraries/v3-sdk'
...
interface OnChainPoolFactoryParams<TPool extends Pool, TPoolMeta extends PoolMeta, TAbi extends Abi | unknown[] = Abi> {
  ...
  buildPoolInfoCalls: (poolAddress: Address) => ContractFunctionConfig[]
