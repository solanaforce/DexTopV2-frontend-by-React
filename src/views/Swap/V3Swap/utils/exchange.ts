import { Currency, CurrencyAmount, TradeType, Percent, ONE_HUNDRED_PERCENT, Token, Price, ZERO } from 'libraries/swap-sdk'
import { SmartRouterTrade, SmartRouter } from 'libraries/smart-router/evm'
...
export function computeSlippageAdjustedAmounts(
  ...
  return {
    [Field.INPUT]: trade ? SmartRouter.maximumAmountIn(trade, pct) : undefined,
    [Field.OUTPUT]: trade ? SmartRouter.minimumAmountOut(trade, pct) : undefined,
  }
}
