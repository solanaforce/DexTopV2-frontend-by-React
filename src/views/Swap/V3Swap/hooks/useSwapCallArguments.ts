...
import { Percent, TradeType } from 'libraries/swap-sdk'
import { SMART_ROUTER_ADDRESSES, SmartRouterTrade, SwapRouter } from 'libraries/smart-router/evm'
...
export function useSwapCallArguments(
  ...
  const recipientENSAddress = useGetENSAddressByName(recipientAddress ?? undefined)
  const recipient = (
